...
public class Car2
{
    ...
    { 
        ...
        rotationInRadians = (rotationInDegrees * Math.PI) / 180;
        ...
        carImage.setX(carImage.getX() + (int)(distX * Math.cos(rotationInRadians)));
        carImage.setY(carImage.getY() + (int)(distX * Math.sin(rotationInRadians)));
